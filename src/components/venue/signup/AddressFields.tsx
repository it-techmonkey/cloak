...
export function UaeAddressFields({ prefix = "" }: { prefix?: string }) {
  ...
  return (
    <div className="grid gap-4 sm:col-span-2 sm:grid-cols-2">
      <label className="grid gap-2 text-sm font-medium text-foreground">
        Emirate
        <select className={inputClass} defaultValue="" name={nm("city")} required>
      ...
      <label className="grid gap-2 text-sm font-medium text-foreground">
        Area / District
        <input className={inputClass} name={nm("addressLine2")} placeholder="Enter area or district" />
      </label>
      <label className="grid gap-2 text-sm font-medium text-foreground sm:col-span-2">
        Building name / Street
        <input className={inputClass} name={nm("addressLine1")} placeholder="Enter building name or street" required />
      </label>
      <input name={nm("postalCode")} type="hidden" value="" />
    </div>
  );
}
